...
export LC_ALL=en_US;
echo "正在登录到fir.im...."
fir login be5d4b7252312f653e44be83e95019be
fir me
echo "正在上传到fir.im...."
fir p $path
changelog=`cat $projectDir/README`
curl -X PUT --data "changelog=$changelog" http://fir.im/api/v2/app/54c0a98d627b6443070000cb?token=be5d4b7252312f653e44be83e95019be
echo "\n打包上传更新成功！"
rm -rf $buildAppToDir
