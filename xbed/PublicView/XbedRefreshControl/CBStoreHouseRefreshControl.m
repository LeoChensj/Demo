...
static const CGFloat kbarDarkAlpha = 0.5;
                          ...
                          internalAnimationFactor:(CGFloat)internalAnimationFactor
{
    ...
    for (int i=0; i<startPoints.count; i++) {
        ...
        if (startPoint.x > width) width = startPoint.x+1;
        if (endPoint.x > width) width = endPoint.x+1;
        if (startPoint.y > height) height = startPoint.y+1;
        if (endPoint.y > height) height = endPoint.y+1;
    }
...
//    {
//        CGFloat asdasd = self.scrollView.contentInset.top;
//        self.originalTopContentInset = asdasd;
//        NSLog(@"asdasd=%f", asdasd);
//    }
    
    self.center = CGPointMake([UIScreen mainScreen].bounds.size.width/2, self.realContentOffsetY*krelativeHeightFactor*1.5);
...
//        self.originalTopContentInset = 0;
        //NSLog(@"originalTopContentInset=%f", self.originalTopContentInset);
