...
- (NSString *)requestUrl
{
    return [NSString stringWithFormat:@"%@/api/auth/order/orderList", URL_HOST];
}
...
- (id)responseModel
{
    ...
    {
        _respModel = [MTLJSONAdapter modelOfClass:[OrderListRespModel class] fromJSONDictionary:self.responseJSONObject error:nil];
    }
