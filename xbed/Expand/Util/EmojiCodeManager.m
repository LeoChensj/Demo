...
@implementation EmojiCodeManager
...
+ (NSString *)encode:(NSString *)str
{
    ...
    NSString *resulte = [[NSString alloc] initWithData:uniData encoding:NSUTF8StringEncoding];
...
+ (NSString *)decode:(NSString *)str
{
    ...
    NSString *resulte = [[NSString alloc] initWithData:jsonData encoding:NSNonLossyASCIIStringEncoding];
